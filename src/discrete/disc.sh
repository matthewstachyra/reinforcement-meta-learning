...
#SBATCH --output=ppo.%j.%N.out #saving standard output to file, %j=JOBID, %N=NodeName
#SBATCH --error=ppo.%j.%N.err #saving standard error to file, %j=JOBID, %N=NodeName
...
python disc-episode-adding-layers.py --n_runs 10 --epochs 20  --timesteps 1000 --n_tasks 7 --sb3_model='PPO' --sb3_policy='MlpPolicy' --data_dir='slurm' --wandb_run="ppo, 10, 20, 1000, 7"
